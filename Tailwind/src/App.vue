...
<template>
  <div class="w-full min-h-screen font-sans text-gray-900">
    <div class="bg-gradient-to-b from-[#FEE6F7] to-white">
      ...
      />
      <div class="px-6 mx-auto max-w-6xl top-0">
      ...
      <div class="px-6 mx-auto max-w-6xl">
        ...
        >
          ...
          >
            <h1
              class="relative z-10 text-5xl font-bold md:text-6xl font-display"
            >
              Learn the
              <span
            ...
            >
              Working at home is definitely a convenient option and makes sense
            ...
            >
              ...
              <button class="flex items-center">
                <img
                  ...
                  class="drop-shadow-lg hover:drop-shadow-xl"
                />
